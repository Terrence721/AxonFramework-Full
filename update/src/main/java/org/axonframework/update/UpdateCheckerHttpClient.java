...
public class UpdateCheckerHttpClient {
    ...
    /**
     * Sends a usage request to the Axoniq servers via an HTTP GET request. The {@code firstRequest} flag is sent
     * along as an {@code X-First-Run} request header, indicating whether this is the first request made by this
     * instance.
     *
