...
public final class AxonVersionDetector {
    ...
    private static List<@Nullable Artifact> detectAxonModules() {
        ...
        try {
            ...
            logger.debug("Failed to retrieve Axon Framework module resources from the classpath", e);
        }
    ...
    private static Artifact mapToAxonVersion(InputStream inputStream) throws IOException {
        ...
        String groupId = mavenProps.getProperty("groupId");
        String artifactId = mavenProps.getProperty("artifactId");
        String version = mavenProps.getProperty("version");
        if (groupId == null || artifactId == null || version == null) {
            throw new IOException("Incomplete pom.properties: missing groupId, artifactId, or version.");
        }
