...
public interface UsagePropertyProvider {
    ...
    /**
     * Parses the given {@code value} as a {@link Boolean}, or returns {@code null} if {@code value} itself is
     * {@code null}. Shared by property-provider implementations that read a boolean flag from an optional
     * string-keyed source, such as a system property or an environment variable.
     *
     * @param value The raw string value to parse, or {@code null} if not present.
     * @return The parsed {@link Boolean}, or {@code null} if {@code value} is {@code null}.
     */
    static @Nullable Boolean parseNullableBoolean(@Nullable String value) {
